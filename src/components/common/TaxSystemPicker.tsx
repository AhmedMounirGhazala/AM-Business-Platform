          ...
          <div className="p-2 border-b border-slate-100 dark:border-slate-800 bg-slate-50/50 dark:bg-slate-800/40">
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-8 pr-3 py-2 rounded-xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 text-xs focus:outline-none focus:border-amber-500 dark:text-white"
              />
            </div>
          </div>
              ...
              filteredTaxSystems.map(t => {
                ...
                return (
                  <button
                    ...
                    className={`w-full min-h-[44px] px-3 py-2.5 rounded-xl text-left transition flex items-center justify-between gap-2 cursor-pointer ${
                      isSelected
