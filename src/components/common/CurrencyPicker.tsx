          ...
          <div className="p-2 border-b border-slate-100 dark:border-slate-800 bg-slate-50/50 dark:bg-slate-800/40">
            <div className="relative">
              ...
              <input
                ...
                className="w-full ps-8 pe-3 py-2 rounded-lg border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 text-xs am-control focus:outline-none focus-visible:ring-2 focus-visible:ring-emerald-500/30 focus:border-emerald-500 dark:text-white"
              />
            </div>
          </div>
